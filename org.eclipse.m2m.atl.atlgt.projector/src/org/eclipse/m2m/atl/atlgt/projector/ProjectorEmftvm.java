 ...
 * A {@link Projector}.
 */
public class ProjectorEmftvm implements Projector {
    ...
    public URI transform(URI module) {
        ...
        System.out.println("Projection of '" + module);

        Resource resource = (new ResourceSetImpl()).getResource(module, true);
